            ...
            <div className="flex justify-between items-center px-4 py-4 sm:px-6 lg:px-8">
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                {user ? (
                  ...
                  <Link to="/login">
                    <button className="bg-[#0d6db7] text-white px-4 py-2 rounded-md hover:bg-[#0b5a99]">
                      Login
                    </button>
                  </Link>
                )}
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              {user ? (
                ...
                <Disclosure.Button
                  as="a"
                  href="/login"
                  className="block px-3 py-2 rounded-md text-base font-medium text-[#0d6db7] hover:bg-[#0b5a99] hover:text-white"
                >
                  Login
                </Disclosure.Button>
              )}
